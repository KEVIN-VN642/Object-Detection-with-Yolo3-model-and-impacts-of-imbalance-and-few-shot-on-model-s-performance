...
batch_seen = tf.Variable(0.)  #put this outsite any functions to avoid the error "Creating variables on a non-first call to a function decorated with tf.function"
...
class YoloLayer(Layer):
    def __init__(self, anchors, max_grid, batch_size, warmup_batches, ignore_thresh, 
        ...
        #cell_grid.shape=(batch_size,max_grid_h,max_grid_w,3,2)
...
def create_yolov3_model(
    ...
    train_model = Model(inputs=[input_image, true_boxes, true_yolo_1, true_yolo_2, true_yolo_3], outputs=[loss_yolo_1, loss_yolo_2, loss_yolo_3])
    infer_model = Model(inputs=input_image, outputs=[pred_yolo_1, pred_yolo_2, pred_yolo_3])
